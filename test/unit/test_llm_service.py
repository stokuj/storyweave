...
class TestExtractRelations:
    ...
    @pytest.mark.asyncio
    async def test_uses_constructor_model(self):
    ...
    @pytest.mark.asyncio
    async def test_prompt_contains_pair_and_sentences(self):
    ...
    @pytest.mark.asyncio
    async def test_returns_empty_on_auth_error(self):
    ...
    @pytest.mark.asyncio
    async def test_returns_empty_when_content_none(self):
...
class TestRelationSchema:
    def test_all_relations_contains_schema_keys(self):
